 ...
 * First project in Data Structures, in collaboration with another student
 * 
 * Authors:
 * Dvir
 *
...
public class WAVLTree {
	...
	public int upperRotation(WAVLNode x,int ind){
		...
		//--:update the sizes according to children a,b,y
	...
	/**--: the method search in the subtree of StartingNode
	...
	*/
	...
	public class WAVLNode {
		...
		public void updateSubtreeSize() {
			if(this.isExternalNode()){//--:external leafs
				size=0;
			}
